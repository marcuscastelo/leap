...
describe("ERC20", async () => {
    ...
    it("Should transfer tokens correctly", async () => {
        ...
        await token.transfer(await recipient.getAddress(), supply);
    ...
    it("Should approve and transferFrom correctly", async () => {
        ...
        await token.connect(router).transferFrom(await deployer.getAddress(), await recipient.getAddress(), supply);
