...
contract LeapCoin is ERC20, Ownable {
    ...
    function claimAllRights() external {
        ...
        require(balances_[address(this)] >= amountToClaim, "LeapCoin: not enough liquidity, try again later");

        balances_[address(this)] -= amountToClaim;
        balances_[account] += amountToClaim;
